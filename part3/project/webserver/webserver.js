        ...
        try {
            ...
            .then(
                (response) => {
                    ...
                    <script>function postTodo () {var todo = document.querySelector('input').value; axios.post(window.location.href + 'todos/' + todo).then(function (response) {console.log(response)}).catch(function (error) {console.log(error)}); window.location.reload();}</script>
