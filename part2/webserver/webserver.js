        ...
        try {
            ...
            .then(
                (response) => {
                    ...
                    <script>function postTodo () {var todo = document.querySelector('input').value; axios.post('http://localhost:8081/todos/' + todo).then(function (response) {console.log(response)}).catch(function (error) {console.log(error)}); window.location.reload();}</script>
